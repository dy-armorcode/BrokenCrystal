...
## Log file name
LOGFILE_NAME = "Orca Security" + '_import.log'
...
url_upload = 'https://qa.armorcode.ai/client/utils/scan/upload'
...
def upload_file(url_api, headers, json_data):
    ...
    try:
        ...
        #requests.put(url_signed, data=open(file_name).read())
    except Exception as e:
